...
lBucketId_atome=`F_influxdb_bucket_getId "${GTW_ATOME_INFLUXDB2_INFLUXDB_BUCKET}"`
LOG_DBG "lBucketId_atome=$lBucketId_atome"
...
F_influxdb_token_create "GTW_ATOME_INFLUXDB2_INFLUXDB_TOKEN" --write-bucket ${lBucketId_atome}
